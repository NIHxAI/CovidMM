...
def main():
    ...
    BATCH_SIZE = args.batch_size if args.batch_size is not None else configs.BATCH_SIZE
    ...
    LEARNING_RATE = args.lr if args.lr is not None else configs.LEARNING_RATE
    optimizer = AdamW(model.parameters(), lr=LEARNING_RATE, weight_decay=1e-4)
    NUM_EPOCHS = args.epochs if args.epochs is not None else configs.NUM_EPOCHS
